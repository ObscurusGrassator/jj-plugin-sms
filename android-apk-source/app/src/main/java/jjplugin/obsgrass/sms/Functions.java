...
public class Functions {
    ...
    public String run(String methodName, JSONObject input) {
        if (methodName.equals("test")) return test(input);
        else if (methodName.equals("sendSMS")) sendSMS(input);
            ...
            Log.e("~=serviceMethod", methodName + " not exists");
            throw new RuntimeException("serviceMethod " + methodName + " not exists");
        }
        return null;
    }
    ...
    public String getContactByNumber(JSONObject input) {
        try {
            Contact contact = getContactByNumber((String) input.get("number"));
            if (contact == null) return "{\"result\":\"\"}";
            else return "{\"number\":" + contact.number + ", \"fullName\":" + contact.fullName + "}";
        } catch (JSONException e) {
            Log.e("~=getContactByNumber()", e.toString());
            throw new RuntimeException("getContactByNumber(): " + e.toString());
        }
    }
    ...
    public String getContactByName(JSONObject input) {
        try {
            Contact contact = getContactByName((String) input.get("name"));
            if (contact == null) return "{\"result\":\"\"}";
            else return "{\"number\":" + contact.number + ", \"fullName\":" + contact.fullName + "}";
        } catch (JSONException e) {
            Log.e("~=getContactByName()", e.toString());
            throw new RuntimeException("getContactByName(): " + e.toString());
        }
    }
    ...
    public String test(JSONObject input) {
        try {
            ...
            Log.e("~=JSON input", e.toString());
            throw new RuntimeException(e);
        } 
    }

    public String sendSMS(JSONObject input) {
        try {
            SmsManager smsManager = SmsManager.getDefault();
            smsManager.sendTextMessage(input.getString("number"), null, input.getString("message"), null, null);    
            return "{\"result\":\"ok\"}";
        } catch (Exception e) {
            Log.e("~=SmsManager", "SMS send error: " + e.toString());
            return "{\"error\":\"SMS send error: " + e.toString() + "\"}";
        }
    }
     ...
     *   };
     */
    public String getNewSMSs(JSONObject input) {
        try {
            ...
            Log.e("~=SmsManager", "getNewSMSs() error: " + e.getMessage());
            return "{\"error\":\"getNewSMSs() error: " + e.getMessage() + "\"}";
        }
    }
